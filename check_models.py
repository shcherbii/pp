...
reserv1 = Reservation(startDate='2021-10-25', endDate='2021-10-29', sum=1202, idUser=1, idCar=1, idStatusResev=1)
reserv2 = Reservation(startDate='2021-10-27', endDate='2021-11-04', sum=3400, idUser=1, idCar=2, idStatusResev=3)
